$(function(){
	...
	var MovieTF = localStorage.getItem('movieIndiv');
	var SeriesTF = localStorage.getItem('seriesIndiv');
	
	if ((MovieTF === 'true') && (SeriesTF === 'false')){
	...
	} else if ((MovieTF === 'false') && (SeriesTF === 'true')){
		
		var seriesID = localStorage.getItem('imdbID');
		
		var apiCall = 'https://api.themoviedb.org/3/tv/' + seriesID + '?api_key=9b788b49ee42354dbc57b8a25b87c9df';
		...
		function dataCallBack(moviesData){
			...
			var movieName = moviesData.original_name;
			var movieOverview = moviesData.overview;
			var movieBudget = moviesData.budget;
			var movieRating = moviesData.vote_average;
			var movieTagline = moviesData.tagline;
